...
public class MuranoIndexedExpressionImpl extends MuranoExpressionImpl implements MuranoIndexedExpression {

  public MuranoIndexedExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof MuranoVisitor) ((MuranoVisitor)visitor).visitIndexedExpression(this);
  ...
  @Override
  @Nullable
  public MuranoExpression getIndexExpression() {
    List<MuranoExpression> p1 = getExpressionList();
