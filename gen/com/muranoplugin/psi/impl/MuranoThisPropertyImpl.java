...
public class MuranoThisPropertyImpl extends ASTWrapperPsiElement implements MuranoThisProperty {

  public MuranoThisPropertyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof MuranoVisitor) ((MuranoVisitor)visitor).visitThisProperty(this);
